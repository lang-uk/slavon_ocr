...
Then do a dedicated TRAILING-ъ SWEEP — this is the LARGEST single error class on Пересторога, beating even є/е:

Пересторога (1605-1606) is early-modern Ukrainian. Unlike Church Slavonic, it has LARGELY DROPPED the silent word-final hard sign ъ after hard consonants. The scholar writes words as they sound — without a decorative ъ tail.

1. For every word in your transcription ending in a hard consonant (д, т, с, н, р, м, л, к, х, в, п, б, г, ж, з), look at the card.
2. DEFAULT is NO trailing ъ. Write a ъ ONLY if you can see a distinct, unambiguous hard-sign glyph as a separate character after the final letter. A natural flourish on ж, д, т, ы, etc. is NOT a ъ.
3. Do NOT apply a "this text looks archaic, so it needs ъ everywhere" reflex. Пересторога's archaic features live in vocabulary and in ѣ/є — NOT in word-final ъ.
4. Concrete cases observed in the proofread corpus — write the LEFT form, NEVER the right one:
   - иж  (not ижъ)
   - обычаєм,  (not обычаємъ,)
   - Книг  (not Книгъ)
   - оных  (not оныхъ)
   - самодержцов  (not самодержцовъ)
   - наукам  (not наукамъ)
   - руских  (not рускихъ)
   - был  (usually not былъ — check the glyph)
   - чим  (not чимъ)
   - так  (not такъ)
5. Word-medial ъ (inside a word, not at the end) is fine where the card shows it. This rule only governs trailing ъ.
...
- BRACKETS: use plain ASCII parentheses ( ) for any parenthesized content, including editorial notes or the scholar's summary annotations. Do NOT use ⟨ ⟩ (U+27E8), ‹ › (U+2039), « », or other decorative variants — the scholar writes plain parens.
